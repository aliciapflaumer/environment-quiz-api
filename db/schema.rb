...
ActiveRecord::Schema.define(version: 20171207195016) do
  ...
  add_index "quizzes", ["quiz_id"], name: "index_quizzes_on_quiz_id", using: :btree
  ...
  add_foreign_key "quizzes", "quizzes"
end
